    ...
    return (
      <div className="bg-teal-100/60 rounded-xl p-4 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div
            className={`${item.color} rounded-full p-3 flex items-center justify-center`}
          >
            {getIcon()}
          </div>
          <div>
        ...
        <div
          className={`${getStatusColor()} text-white px-4 py-2 rounded-full text-sm font-medium`}
        >
          {item.status}
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-teal-300">
            See what issues your community is reporting and share your support
          </p>
        </div>
