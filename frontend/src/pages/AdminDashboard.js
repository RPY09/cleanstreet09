            ...
            <div className="tab-content">
              ...
              <div className="community-impact">
                ...
                <div className="impact-card">
                  <p>
                    Thanks to citizen reports and community engagement, we've
                    resolved <strong>{stats.resolvedThisMonth} issues</strong>{" "}
          ...
          {tab === "complaints" && (
            <div className="tab-content">
              ...
              <div className="coming-soon">
                ...
                <p>
                  This section will allow you to view, filter, and manage all
                  complaints.
                </p>
              </div>
            </div>
          ...
          {tab === "reports" && (
            <div className="tab-content">
              ...
              <div className="coming-soon">
                ...
                <p>
                  This section will provide detailed analytics and reporting
                  features.
                </p>
              </div>
            </div>
